    ...
    <div className="min-h-screen bg-noir pt-24 pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="font-playfair text-5xl md:text-6xl text-blanc mb-4">Contact</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-8">
            <div className="border border-or/20 p-8 bg-blanc/[0.02] space-y-6">
              <h2 className="font-playfair text-2xl text-or mb-2">Informations</h2>

              <div className="flex items-start gap-3">
                <MapPin size={18} className="text-or mt-0.5 shrink-0" />
                <div>
                  <p className="font-jost text-sm text-blanc/70">{config.adresse}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="font-jost text-sm text-blanc/70 hover:text-or transition-colors"
                >
              ...
              <div className="flex items-start gap-3">
                <Clock size={18} className="text-or mt-0.5 shrink-0" />
                <p className="font-jost text-sm text-blanc/70 whitespace-pre-line">{config.horaires}</p>
              </div>
            </div>

            {/* Social links */}
            <div className="border border-or/20 p-8 bg-blanc/[0.02]">
              <h2 className="font-playfair text-2xl text-or mb-5">Réseaux sociaux</h2>
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 text-blanc/50 hover:text-or transition-colors group"
                  >
                    <span className="p-2 border border-or/20 group-hover:border-or transition-colors">
                      <Icon size={15} />
                    </span>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 w-full py-4 bg-[#25D366] text-white font-jost text-sm tracking-widest uppercase hover:bg-[#25D366]/90 transition-all"
            >
          ...
          {/* Google Maps embed */}
          <div className="border border-or/20 overflow-hidden">
            <iframe
