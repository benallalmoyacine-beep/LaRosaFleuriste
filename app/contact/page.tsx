...
export const metadata: Metadata = {
  title: "Contact â€” La Rosa Fleuriste",
  description: "Contactez La Rosa Fleuriste Ã  Tlemcen. Commandez par WhatsApp ou visitez-nous.",
};
...
export default async function ContactPage() {
  const config = await getConfig().catch(() => ({
    ...
    horaires: "Lunâ€“Sam 8hâ€“20h Â· Dim 9hâ€“18h",
    noteGoogle: 4.6,
    nbAvis: 24,
  }));
    ...
    <div className="min-h-screen bg-blanc pt-20 md:pt-24 pb-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <h1 className="font-sans text-4xl md:text-6xl text-noir mb-4">Contact</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
          ...
          <div className="space-y-6">
            ...
            <div className="border border-border bg-white p-6 md:p-8 space-y-5">
              <h2 className="font-sans text-xl md:text-2xl text-noir mb-2">Informations</h2>

              <div className="flex items-start gap-3">
                <MapPin size={16} className="text-or mt-0.5 shrink-0" />
                <p className="font-sans text-sm text-muted">{config.adresse}</p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="font-sans text-sm text-muted hover:text-noir transition-colors"
                >
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="font-sans text-sm text-muted whitespace-pre-line">{config.horaires}</p>
              </div>
            </div>

            {/* RÃ©seaux sociaux */}
            <div className="border border-border bg-white p-6 md:p-8">
              <h2 className="font-sans text-xl md:text-2xl text-noir mb-5">RÃ©seaux sociaux</h2>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 w-full py-4 bg-[#25D366] text-white font-sans text-sm tracking-widest uppercase hover:bg-[#1ebe5d] transition-all"
            >
          ...
          <div className="border border-border overflow-hidden min-h-[350px] md:min-h-[500px]">
            <iframe
              ...
              title="La Rosa Fleuriste â€” Tlemcen"
            />
          </div>
        </div>
      </div>
